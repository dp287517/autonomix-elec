...
<body class="container my-5">
          ...
          <table class="table table-striped align-middle">
            <thead>
              <tr>
                ...
                <th>Local</th><th>Zone G</th><th>Zone D</th><th>Conformité</th><th>Statut</th><th>Risque</th>
          ...
          <form id="equipForm" novalidate>
            ...
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <div class="form-text">Tu peux saisir **Gaz** et **Poussières** dans la même ligne (séparés par ‘/’) si besoin.</div>
              </div>
              <div class="col-md-6">
          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <div id="chatEnriched" class="mt-3" style="display:none">
                ...
                <div class="mt-3">
                  <h6>Pièces & Liens d’achat (manuel)</h6>
                  <div class="row g-2 align-items-end">
                    <div class="col-md-7">
                      ...
                      <select id="partType" class="form-select">
                        ...
                        <option value="boite_e">Boîte de jonction Ex e (R. STAHL)</option>
                        <option value="boite_d">Boîte de jonction Ex d (R. STAHL)</option>
                  ...
                  <div class="mt-2 small-muted">Les liens ouvrent les distributeurs/fabricants (IFM, R.STAHL, RS UK) pour comparer et obtenir un prix réel.</div>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <dl class="def-list">
            ...
            <dd>Calculée à partir de la dernière inspection + fréquence (par défaut 3 ans). Mise à jour automatiquement à chaque inspection.</dd>
            <dt>Risque (0–5)</dt>
            <dd>Basé sur la zone la plus sévère (0/20 → 5, 1/21 → 3, 2/22 → 1) augmenté de +2 si Non Conforme. Limité entre 0 et 5.</dd>
            <dt>Conformité</dt>
            <dd>Comparaison du marquage ATEX avec les exigences **gaz** et **poussières**. L’état global est **Non Conforme** si l’une des deux filières (G/D) n’est pas satisfaite.</dd>
          </dl>
        </div>
      </div>
    </div>
  ...
  <footer class="text-center small mt-4">© AutonomiX — Tous droits réservés</footer>
      ...
      list.forEach(eq=>{
        ...
        tr.innerHTML = `
          ...
          <td class="actions">
            ...
            <button class="btn btn-sm ${ hasIAHistory(eq.id) ? 'btn-success' : (isNC?'btn-warning':'btn-outline-secondary') }" onclick="openIA(${eq.id})" title="IA AutonomiX"><i data-lucide="sparkles"></i> IA</button>
          </td>
        `;
    ...
    <div class="modal-dialog modal-fullscreen">
      <div class="modal-content bg-dark">
        <div class="modal-header border-0">
          <h5 class="modal-title text-white" id="attViewerTitle">Aperçu</h5>
